...
function slice<U, T extends ArrayLike<U>>(arr: T, start: number, end: number): T {
  ...
  if ((arr as any).buffer instanceof ArrayBuffer) {
    ...
    assert(_.isFunction((arr as any).slice));
...
function extract_matrix_range<U, T extends ArrayLike<U>>(array: T, rowRange: number[], colRange: number[], dimension?: number[]): ExtractResult<T> {
