...
class ServerEngine extends events_1.EventEmitter {
    ...
    createSession(options) {
        ...
        session.on("timeout", () => {
            ...
            console.log(chalk.cyan("Server: closing SESSION "), session.status, chalk.yellow(session.sessionName), chalk.cyan(" because of timeout = "), session.sessionTimeout, chalk.cyan(" has expired without a keep alive"));
