    ...
    _tick() {
        ...
        if (doDebug) {
            debugLog((t(new Date()) + "  " + this._life_time_counter + "/" + this.lifeTimeCount +
                chalk.cyan("   Subscription#_tick")), "  processing subscriptionId=", this.id, "hasMonitoredItemNotifications = ", this.hasMonitoredItemNotifications, " publishingIntervalCount =", this.publishIntervalCount);
        }
