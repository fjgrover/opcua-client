...
function readUAStructure(proxyManager, obj, callback) {
    ...
    session.browse(nodesToBrowse, (err, browseResults) => {
        ...
        async.series([
            (callback) => {
                async.mapSeries(browseResults[0].references, (reference, callback) => add_component(proxyManager, obj, reference, callback), (err) => callback(err));
            },
            (callback) => {
                async.mapSeries(browseResults[1].references, (reference, callback) => add_property(proxyManager, obj, reference, callback), (err) => callback(err));
            },
            // now enrich our object with nice callable async methods
            (callback) => {
                async.mapSeries(browseResults[2].references, (reference, callback) => add_method(proxyManager, obj, reference, callback), (err) => callback(err));
            },
