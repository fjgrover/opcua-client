...
import { ClientSecureChannelLayer, ConnectionStrategy, ConnectionStrategyOptions, ErrorCallback, SecurityPolicy, SecurityToken } from "node-opcua-secure-channel";
import { FindServersOnNetworkRequest, FindServersOnNetworkRequestOptions, FindServersRequest, FindServersRequestOptions, ServerOnNetwork } from "node-opcua-service-discovery";
...
export declare type FindServersRequestLike = FindServersRequest | FindServersRequestOptions;
export declare type FindServersOnNetworkRequestLike = FindServersOnNetworkRequest | FindServersOnNetworkRequestOptions;
