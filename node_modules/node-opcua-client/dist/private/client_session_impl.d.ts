...
import { BrowseNextResponse } from "node-opcua-types";
...
export declare class ClientSessionImpl extends EventEmitter implements ClientSession {
    ...
    processTransactionQueue: (request: Request, callback: (err: Error | null, response?: import("node-opcua-types").FindServersResponse | import("node-opcua-types").FindServersOnNetworkResponse | import("node-opcua-service-endpoints").GetEndpointsResponse | import("node-opcua-types").CreateSessionResponse | import("node-opcua-types").ActivateSessionResponse | import("node-opcua-types").CloseSessionResponse | BrowseResponse | BrowseNextResponse | TranslateBrowsePathsToNodeIdsResponse | RegisterNodesResponse | UnregisterNodesResponse | QueryFirstResponse | import("node-opcua-service-query").QueryNextResponse | ReadResponse | HistoryReadResponse | WriteResponse | CallResponse | CreateMonitoredItemsResponse | ModifyMonitoredItemsResponse | SetMonitoringModeResponse | DeleteMonitoredItemsResponse | CreateSubscriptionResponse | ModifySubscriptionResponse | SetPublishingModeResponse | PublishResponse | RepublishResponse | TransferSubscriptionsResponse | DeleteSubscriptionsResponse | undefined) => void) => void;
