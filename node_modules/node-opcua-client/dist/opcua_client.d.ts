...
import { ConnectionStrategyOptions, ErrorCallback, SecurityPolicy } from "node-opcua-secure-channel";
...
export interface OPCUAClient extends OPCUAClientBase {
    ...
    withSessionAsync<T>(endpointUrl: string, inner_func: (session: ClientSession) => Promise<T>): Promise<T>;
