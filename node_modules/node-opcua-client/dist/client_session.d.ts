...
import { CreateMonitoredItemsRequest, CreateMonitoredItemsRequestOptions, CreateMonitoredItemsResponse, CreateSubscriptionRequest, CreateSubscriptionRequestOptions, CreateSubscriptionResponse, DeleteMonitoredItemsRequest, DeleteMonitoredItemsRequestOptions, DeleteSubscriptionsRequest, DeleteSubscriptionsRequestOptions, DeleteSubscriptionsResponse, ModifyMonitoredItemsRequest, ModifyMonitoredItemsRequestOptions, ModifyMonitoredItemsResponse, ModifySubscriptionRequest, ModifySubscriptionRequestOptions, ModifySubscriptionResponse, PublishRequest, PublishResponse, RepublishRequest, RepublishResponse, SetMonitoringModeRequest, SetMonitoringModeRequestOptions, SetMonitoringModeResponse, TransferSubscriptionsRequest, TransferSubscriptionsRequestOptions, TransferSubscriptionsResponse } from "node-opcua-service-subscription";
...
export declare type ReadValueIdLike = ReadValueIdOptions | ReadValueId;
export declare type WriteValueLike = WriteValueOptions | WriteValue;
export declare type DeleteMonitoredItemsRequestLike = DeleteMonitoredItemsRequestOptions | DeleteMonitoredItemsRequest;
export declare type CreateSubscriptionRequestLike = CreateSubscriptionRequestOptions | CreateSubscriptionRequest;
export declare type DeleteSubscriptionsRequestLike = DeleteSubscriptionsRequestOptions | DeleteSubscriptionsRequest;
export declare type TransferSubscriptionsRequestLike = TransferSubscriptionsRequestOptions | TransferSubscriptionsRequest;
export declare type CreateMonitoredItemsRequestLike = CreateMonitoredItemsRequestOptions | CreateMonitoredItemsRequest;
export declare type ModifyMonitoredItemsRequestLike = ModifyMonitoredItemsRequestOptions | ModifyMonitoredItemsRequest;
export declare type ModifySubscriptionRequestLike = ModifySubscriptionRequestOptions | ModifySubscriptionRequest;
export declare type SetMonitoringModeRequestLike = SetMonitoringModeRequestOptions | SetMonitoringModeRequest;
export declare type QueryFirstRequestLike = QueryFirstRequestOptions | QueryFirstRequest;
