...
export function referenceTypeToString(
...
export function dumpReferenceDescription(
  addressSpace: AddressSpace,
...
export function dumpReferenceDescriptions(
  addressSpace: AddressSpace,
...
export function dumpBrowseDescription(
  node: BaseNode,
