...
export declare class UADataType extends BaseNode implements UADataTypePublic {
     ...
     */
    get binaryEncodingNodeId(): any;
    get binaryEncoding(): BaseNode;
    get binaryEncodingDefinition(): string;
    get xmlEncoding(): BaseNode;
    get xmlEncodingNodeId(): NodeId;
    get xmlEncodingDefinition(): string;
    _getDefinition(): any;
