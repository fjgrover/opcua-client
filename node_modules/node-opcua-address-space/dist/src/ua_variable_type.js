    ...
    _.forEach(extraInfo.mapOrgToClone, (value, key) => {
        ...
        originalNonHierarchical.forEach((ref) => {
            ...
            if (info) {
                ...
                // istanbul ignore next
                if (doDebug) {
                    debugLog(chalk.cyan("   adding reference "), ref.referenceType, " from cloned ", clonedObject.nodeId.toString(), clonedObject.browseName.toString(), " to cloned ", cloneDest.nodeId.toString(), cloneDest.browseName.toString());
                }
                // restore reference
