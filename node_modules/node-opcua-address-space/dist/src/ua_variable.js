    ...
    bindExtensionObject(optionalExtensionObject) {
        ...
        for (const field of dt.definition) {
            ...
            if (doDebug) {
                ...
                console.log(chalk.cyan("xxx"), " dataType", w(field.dataType.toString(), 8), w(field.name, 35), "valueRank", chalk.cyan(w(field.valueRank, 3)), chalk.green(w(x, 25)), "basicType = ", chalk.yellow(w(basicType.toString(), 20)), property.nodeId.toString(), property.readValue().statusCode.toString());
            }
